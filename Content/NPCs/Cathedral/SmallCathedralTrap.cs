    ...
    internal class SmallCathedralTrap : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            if (NPC.velocity.Y == 0 && NPC.ai[1] != 1)
            {
                ...
                {
                    Player.GetModPlayer<skyboundPlayer>().Shake = (350 - (int)Vector2.Distance(Player.Center, NPC.Center)) / 12;
                    Terraria.Audio.SoundEngine.PlaySound(SoundID.Item70.WithPitchVariance(0.2f), NPC.Center);
                }
                NPC.ai[1] = 1;
            }
        }
