...
namespace skybound.Core
{
    class ShaderLoader : IOrderedLoadable
    {
        ...
        public void Load()
        {
            ...
            var file = (TmodFile)info.Invoke(skybound.Instance, null);
        ...
        {
            var screenRef = new Ref<Effect>(skybound.Instance.Assets.Request<Effect>(path, ReLogic.Content.AssetRequestMode.ImmediateLoad).Value);
